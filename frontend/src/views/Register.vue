...
<template>
  <div class="bg-cover bg-center h-screen bg-opacity-50" :style="{ backgroundImage: `url(${Spacebg})` }">
    <div class="flex items-center justify-center h-full">
      <div class="bg-[#FFF] w-[500px] h-[640px] rounded-[70px] border border-[5px] border-black gap-3 flex flex-col">
        <img :src="SpaceImage" alt="" class="rounded-t-[70px]" />
        <p class="p-2 pl-8 text-black font-smath text-3xl font-bold">Register</p>
